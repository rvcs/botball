...
namespace rvcs {
  ...
  BlobList filter_skininess(BlobList const & list, float lt = 1.0, float gt = 3.0, BlobList * premoved = NULL);
  BlobList filter_area(BlobList const & list, int lt, int gt, BlobList * premoved = NULL);
  BlobList filter_x(BlobList const & list, int lt, int gt, BlobList * premoved = NULL);
  BlobList filter_y(BlobList const & list, int lt, int gt, BlobList * premoved = NULL);
  BlobList filter_doesnt_contain(BlobList const & list, struct point2 const & pt, BlobList * premoved = NULL);
